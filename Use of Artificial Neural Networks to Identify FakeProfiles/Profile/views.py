...
def importdata(): 
    balance_data = pd.read_csv('C:/Users/nikit/OneDrive/Desktop/Use of Artificial Neural Networks to Identify FakeProfiles/Profile/dataset/dataset.txt')
...
def ViewTrain(request):
    if request.method == 'GET':
       ...
       data = pd.read_csv('C:/Users/nikit/OneDrive/Desktop/Use of Artificial Neural Networks to Identify FakeProfiles/Profile/dataset/dataset.txt')
